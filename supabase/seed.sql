...
values
  (
    ...
    '+995555000001', 'DEV Seed', 'DEV · BMW 330i', 2021, 24900, 'GEL', 85000,
  ...
  (
    ...
    '+995555000002', 'DEV Seed', 'DEV · Toyota RAV4', 2020, 21800, 'USD', 94000,
  ...
  (
    ...
    'USD', 43000, '3.0', 'ავტომატიკა', 'თბილისი', 'preview_ready', 'complete', 5,
  ...
  (
    ...
    '+995555000004', 'DEV Seed', 'DEV · Ford Mustang', 2019, 37500, 'USD', 51000,
  ...
  (
    ...
    '+995555000005', 'DEV Seed', 'DEV · Porsche Macan S', 2021, 68900, 'USD', 37000,
  ...
  (
    ...
    '+995555000006', 'DEV Seed', 'DEV · Honda CR-V', 2018, 17900, 'GEL', 112000,

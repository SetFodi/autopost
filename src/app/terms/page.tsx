      ...
      <main className="min-h-[70vh] py-16 sm:py-24">
        <article className="site-container max-w-4xl">
          ...
          <div className="legal-copy pt-4 pb-10 sm:pb-16">
            ...
            <h2>უფასო Preview</h2>
            <p>
              პირველი Preview უფასოა, შეიცავს თვალსაჩინო watermark-ს და
            ...
            <p>
              ...
              watermark-ის გარეშე მომზადებული Reel, 3 Story, 6-სლაიდიანი
            ...
            <p>
              ...
              ავტომატურად ქმნის watermark-ის გარეშე ფაილებსა და ZIP პაკეტს.

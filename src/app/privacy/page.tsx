      ...
      <main className="min-h-[70vh] py-16 sm:py-24">
        <article className="site-container max-w-4xl">
          ...
          <div className="legal-copy pt-4 pb-10 sm:pb-16">
            ...
            <p>
              ნომერს ვიყენებთ განაცხადის დასაკავშირებლად, საჭიროებისას
              მხარდაჭერისთვის და მომხმარებლის მიერ მოთხოვნილ გასაყიდ მასალაში
              საკონტაქტო ინფორმაციის ჩასასმელად. მასალა ინახება პირად შედეგის
              გვერდზე და AutoPost მას საჯაროდ არ აქვეყნებს. მომხმარებლის
            ...
            <p>
              ...
              carousel-ის, კვადრატული ბარათისა და ტექსტის ავტომატურად
              მოსამზადებლად. იქმნება წყლის ნიშნით დაცული წინასწარი ვერსია, რათა
              მომხმარებელმა შედეგი გადახდამდე შეაფასოს.
            </p>
            <p>
              ატვირთვამდე თავსებადი ბრაუზერი ფოტოს ადგილობრივად ხელახლა ქმნის და
              ახალ ფაილში არ გადააქვს საწყისი EXIF/GPS, კამერის ან ტექსტური
              მეტამონაცემები. ამ დროს ინარჩუნებს ფოტოს სწორ ორიენტაციას და
              ხარისხს ზომის დასაშვებ ზღვარში. თუ ბრაუზერი, განსაკუთრებით
              HEIC/HEIF ფორმატისთვის, უსაფრთხო გარდაქმნას ვერ ასრულებს, ფაილი არ
              აიტვირთება და მომხმარებელი მიიღებს ფორმატის შეცვლის მკაფიო
              მითითებას.
            </p>
            ...
            <p>
              დადასტურებული მოთხოვნის დამუშავებისას ჯერ ვშლით დახურულ საცავში
              შენახულ ფოტოებს, შემდეგ კი განაცხადის საკონტაქტო და ავტომობილის
              მონაცემებსა და ფაილების ტექნიკურ ჩანაწერებს. თუ მომხმარებლისთვის
              მომზადებული მასალა დახურულ საცავში ინახება, მასაც ვშლით იმავე
              მოთხოვნის ფარგლებში. არაპერსონალური, განაცხადთან კავშირის გარეშე
              დარჩენილი ანალიტიკური მოვლენა შეიძლება დარჩეს სერვისის საერთო
              მაჩვენებლების სიზუსტისთვის.
            </p>
            <p>
              მიმდინარე validation MVP-ში დასრულებული განაცხადების ავტომატური
              წაშლის ფიქსირებული ვადა ჯერ არ არის დანერგილი. შენახვის პრაქტიკას
              პერიოდულად გადავხედავთ და მონაცემებს აღარ შევინახავთ, როცა ისინი
              აღნიშნული მიზნებისთვის საჭირო აღარ იქნება. წაშლის მოთხოვნა
              ნებისმიერ დროს შეგიძლია.
            </p>

...
values
  (
    ...
    '+995555000001', 'DEV Seed', 'private_seller', 'DEV · BMW 330i', 2021,
    24900, 'GEL', 85000, '2.0 Turbo', 'ავტომატიკა', 'თბილისი', 'facebook',
    'paid_social', 'campaign-validation', 'feed-private', 'car-sale', 'new',
    'complete', 5, true,
  ...
  (
    ...
    '+995555000002', 'DEV Seed', 'dealer', 'DEV · Toyota RAV4', 2020, 21800,
    'USD', 94000, '2.5 Hybrid', 'ავტომატიკა', 'ბათუმი', 'instagram',
    'paid_social', 'campaign-validation', 'story-dealer', null, 'in_progress',
    'complete', 5, true, 'Development-only in-progress example.', null, 0,
    null, null, now() - interval '1 day', 'v1:' || repeat('2', 64),
    'v1:' || repeat('b', 64), now() - interval '1 day'
  ),
  (
    '10000000-0000-4000-8000-000000000003', 'AP-DE00000003',
    '+995555000003', 'DEV Seed', 'private_seller',
    'DEV · Mercedes-Benz GLE 450', 2022, 62500, 'USD', 43000, '3.0',
    'ავტომატიკა', 'თბილისი', null, null, null, null, null, 'preview_ready',
    'complete', 5, true, 'Development-only Preview-ready example.',
  ...
  (
    ...
    '+995555000004', 'DEV Seed', 'dealer', 'DEV · Ford Mustang', 2019, 37500,
    'USD', 51000, '5.0', 'ავტომატიკა', 'ქუთაისი', null, null, null, null, null,
    'delivered', 'complete', 5, true, 'Development-only delivered example.',
  ...
  (
    ...
    '+995555000005', 'DEV Seed', 'private_seller', 'DEV · Porsche Macan S',
    2021, 68900, 'USD', 37000, '2.9', 'ავტომატიკა', 'თბილისი', null, null, null,
    null, null, 'converted', 'complete', 5, true,
  ...
  (
    ...
    '+995555000006', 'DEV Seed', 'private_seller', 'DEV · Honda CR-V', 2018,
    17900, 'GEL', 112000, '2.4', 'ავტომატიკა', 'რუსთავი', null, null, null, null,
    null, 'rejected', 'complete', 5, true,

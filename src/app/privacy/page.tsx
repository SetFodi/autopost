        ...
        <article className="site-container max-w-4xl">
          ...
          <div className="legal-copy pt-4 pb-10 sm:pb-16">
            ...
            <p>
              ...
              მომზადებული მასალა ცალკე, მაგალითად Drive-ის დახურულ საქაღალდეში
              ინახება, მასაც ვშლით იმავე მოთხოვნის ფარგლებში. არაპერსონალური,
              განაცხადთან კავშირის გარეშე დარჩენილი ანალიტიკური მოვლენა შეიძლება
              დარჩეს სერვისის საერთო მაჩვენებლების სიზუსტისთვის.
            </p>
            <p>
